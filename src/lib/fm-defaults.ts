...
export const DEFAULT_TITLE_WEIGHTS: { match: string; label: string; weight: number }[] = [
  ...
  { match: "club world cup", label: "Mundial de Clubes", weight: 600 },
  { match: "europa league", label: "Europa League", weight: 300 },
  { match: "conference", label: "Conference League", weight: 200 },
  { match: "sudamericana", label: "Sul-Americana", weight: 250 },
  { match: "superleague", label: "SuperLeague", weight: 800 },
];
