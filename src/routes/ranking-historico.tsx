    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="clubes">
        <TabsList>
          ...
          {source !== "continental" && <TabsTrigger value="treinadores"><Users className="size-4 mr-1" /> Treinadores</TabsTrigger>}
          <TabsTrigger value="paises"><Globe2 className="size-4 mr-1" /> Países</TabsTrigger>
        </TabsList>
